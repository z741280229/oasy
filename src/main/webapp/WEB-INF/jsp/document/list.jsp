...
<script type="text/javascript">
    $(document).ready(function() {
        var cat = $("#catalog");
        cat.load(rootPath + "/document/catalog/?distinguish="+'${distinguish}')

        var tb = $("#fileList");
        tb.load(rootPath + "/document/singlelist/?distinguish="+${distinguish})
    });
</script>
<script>
    function addCatalog() {
        $.post(rootPath+"/document/addCat",$("#add_cat_form").serialize(),function (data) {
            ...
            var cat = $("#loadhtml");
            cat.load(rootPath + "/document/list/?distinguish="+'${distinguish}')
        })
    }
</script>
